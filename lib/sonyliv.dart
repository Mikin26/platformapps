...
import 'package:multiapp/amazommoive.dart';
import 'package:multiapp/model.dart';
import 'package:multiapp/sonymovie.dart';

class Sonyliv extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _SonylivState();
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        //     tabs: [
        //       Container(color: Colors.black, child: Icon(Icons.home)),
        //       Container(
        //         color: Colors.black,
                        ...
                        return InkWell(
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => Sonylivmovie(e)));
                          },
                          child: Container(
